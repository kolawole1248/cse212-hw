public static class Trees
{
    ...
    {
        // Base case: If the sub-array is empty, return
        if (first > last)
        {
            return;
        }
        ...
        // Recursively insert the middle value of the left sub-array
        InsertMiddle(sortedNumbers, first, middle - 1, bst);

        // Recursively insert the middle value of the right sub-array
